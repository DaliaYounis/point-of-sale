                            ...
                            @foreach ($users as $index=>$user)
                                <tr>
                                    ...
                                    @if(auth()->user()->hasPermission('users_update'))
                                        ...
                                        @else
{{--                                                <a href="#" class="btn btn-danger btn-sm disabled"><i class="fa fa-delete"></i> @lang('site.delete')</a>--}}

                                                <button class="btn btn-sm btn-danger delete disabled"> @lang('site.delete')</button>
                                               @endif
                                    </td>
                                </tr>
