                    ...
                    <form action="{{ route('dashboard.products.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            <div class="form-group">
                                ...
                                <input type="text" name="name[{{$localeCode}}]" class="form-control" value="{{ old('name.'.$localeCode)}}">
                            </div>

                            <div class="form-group">
                                <label>@lang('site.'.$localeCode.'.description')</label>

                                <textarea type="text" name="description[{{$localeCode}}]" class="form-control ckeditor" >{{ old('description.'.$localeCode)}}</textarea>
                            </div>
                        @endforeach
                        <div class="form-group">
